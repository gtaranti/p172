defmodule P172Web.ProductLiveTest do
  use P172Web.ConnCase

  import Phoenix.LiveViewTest
  import P172.ProductsFixtures

  @create_attrs %{model: "some model", price: "some price"}
  @update_attrs %{model: "some updated model", price: "some updated price"}
  @invalid_attrs %{model: nil, price: nil}
